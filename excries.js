...
// Take any number check if number is even and also check if number is multiple of 4 or not.
...
// Question 7 
//   Take city temprature.
//   If temp is less than 10 degree then print very cold.
//   If city temp is less than 30 and greater than equal to 10 then print cold.
//   If temp is between 30 to 40 then print Hot. Else print Very hot
...
// Question 8
// Using prompt ask user about his/her age.
//  If user is greater than 18 then show user
//   message "Do you want to open account?" If yes click
//    on Okay button then ask your 4 below questions
// What is your name ?
// What is your aaadhar number ?
// What is your address?
// What is your mobile number?
//  And print all these details in console. 
...
// Question 9
// Create a simple calcultor. Firslty ask your about the operation.
//  Like "What do you want to do?" User can type choice in any way
//  like +,- or plus, minus or add, sub etc. After that ask user
//  about first number and then second number and finally show the 
//  desired output.
...
// Question 10
// Who is most intelligent in your family? 
// Ask 10th percentage of each family member and check who got the highest marks.
